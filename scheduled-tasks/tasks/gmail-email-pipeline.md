...
draft suggested replies using Drive context, notify via bot-talk when Albert
Alexander is mentioned, and send Sahar a Telegram summary.
...
### Step 9: Check for Albert Alexander mention
...
### Step 11: Send Telegram summary to Sahar
...
Email 1: jane@acme.com "Q4 proposal" — created CRM contact, 2 Drive files matched, no Albert mention, reply drafted.
Email 2: bob@supplier.com "Invoice #123" — found existing CRM contact, 0 Drive files matched, no Albert mention, reply drafted.
